    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="mt-8">
            <Link to="/pricing" className="inline-flex rounded-full bg-foreground px-7 py-3.5 text-sm font-medium text-background hover:bg-foreground/85 transition-colors">
              See packages & rates
            </Link>
          </div>
        </div>
